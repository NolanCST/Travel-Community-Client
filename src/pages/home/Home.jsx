         ...
         <div className="presentation">
            <div className="part1">
               ...
               <p className="preDescription">
                  Découvrir de nouveaux horizons, explorer des contrées lointaines, et s'émerveiller devant la diversité du monde. Voyager facilement, c'est ouvrir les portes de l'aventure et s'immerger dans des cultures riches en histoire et en
                  tradition. Que ce soit par les airs, sur terre ou sur mer, l'appel de l'exploration nous pousse à parcourir des kilomètres, à dépasser les frontières et à embrasser la beauté infinie de notre planète. Chaque voyage est une
                  expérience unique, une opportunité de grandir, d'apprendre et de se connecter avec le monde qui nous entoure. Alors, laissez-vous emporter par la magie du voyage et laissez vos souvenirs se remplir de moments inoubliables.{" "}
               </p>
